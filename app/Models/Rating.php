...
class Rating extends Model
{
    ...
    /**
     * Get the target model (Rachma or Designer) - polymorphic relationship
     */
    public function ratable()
    {
        return $this->morphTo('ratable', 'target_type', 'target_id');
    }

    /**
     * Get the target model (Rachma or Designer) - legacy method for backward compatibility
     */
    ...
    /**
     * Scope to get ratings for rachmat
     */
    ...
    /**
     * Scope to get ratings for stores
     */
    ...
    /**
     * Scope to get ratings by target
     */
