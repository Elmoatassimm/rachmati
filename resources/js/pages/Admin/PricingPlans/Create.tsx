...
export default function Create() {
  ...
  return (
    <AppLayout>
      <Head title="إضافة خطة تسعير جديدة" />
      
      <div className="space-y-8 p-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-foreground">إضافة خطة تسعير جديدة</h1>
            <p className="text-xl text-muted-foreground mt-2">
              إنشاء خطة اشتراك جديدة للمصممين
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex gap-4 pt-6">
                  ...
                  >
                    ...
                    {processing ? 'جاري الحفظ...' : 'حفظ الخطة'}
                  </Button>
                  <Link href="/admin/pricing-plans">
                    <Button
                      type="button"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  <p className="flex items-center gap-2">
                    ...
                    سيتمكن المصممون من رؤية هذه الخطة عند طلب الاشتراك
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-primary rounded-full"></span>
                    يمكن تعديل تفاصيل الخطة لاحقاً من صفحة التحرير
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-primary rounded-full"></span>
                    الخطة ستكون نشطة ومتاحة للمصممين فور الإنشاء
                  </p>
                </div>
              </div>
            </CardContent>
